...
namespace SimpleMeshGraphics
{
    public class TexturedObject : MeshedObject
    {
        ...
        public TexturedObject(string objFile, string textureFile, GL gl, Shader s) : base(objFile, gl, s)
        {
        ...
        public override void Render(double deltaTime, Camera c)
        {
            switch (textureSlot)
            {
